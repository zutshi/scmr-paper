...
be `safe' as it can not find a counter-example. Also, PWA-Rel performs
better with the LP solver as PWA-Rel+SAL times out on most of the
benchmarks. However, we need to explore more benchmarks to
