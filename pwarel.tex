...
\begin{definition}[Graph Abstraction]
    ...
    corresponds to a cell $V_i = C_i$, and an edge exists between two
    cells $(C_j, C_k) \in E$ iff there exist state-input pairs
    $(\vx,\vu) \in C_j$, $(\vx', \vu) \in C_k$ such that $\vx =
    \simulate(\vx, \vu )$.
\end{definition}
