...
(\HybridStates, \vu, t) \mapsto \HybridStates$.  A simulation step
computes the unique reachable state $\vx \in \HybridStates$ in time
...
Hence, $\vy=\simulate^{\System}(\vx,u,t)$ \emph{iff} $\vx \reach{t,u}
\vy$.
...
\myipara{System Assumptions:} We require that $\System$ be
forward deterministic. This
...
the $\simulate$ function and {\em do not} assume that an analytic closed-form
