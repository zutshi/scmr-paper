...
concrete counter-example in the model~\footnote{Due to modeling
errors, this might not be reproducible in the original black-box
system.}. We then use this counter-example to guide the search towards
a counter-example in the original system.
